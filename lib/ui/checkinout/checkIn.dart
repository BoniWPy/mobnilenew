...
class ScanScreenIn extends StatefulWidget {
  @override
  _ScanState createState() => new _ScanState();
}

class _ScanState extends State<ScanScreenIn> {
  var result = "";
  ...
  var token = 'fhjkdshfdjsf';
  int user_id = 1;
  int company_id = 15;
  int employee_id = 4;
  int employee_employ_id = 4;
  double lat = 45.90;
  double long = 104.33;
  int company_config_id = 3;
  ...
  Future _checkGps() async {
    ...
    print('isi config location di function _checkgps ->, $config_location');
