...
class DatabaseHelper {
  static final _databaseName = "payrightmobile.db";
  ...
  // static final columnCompanyId    = 'companyId';
  ...
  //           $columnCompanyName TEXT NULL,
  // $columnCompanyId INTEGER NULL,
  // $columnEmployeeId INTEGER NULL,
  // $columnBarcode TEXT NULL,
  // $columnLat TEXT NULL,
  // $columnLong TEXT NULL,
  // $columnCreateDate TEXT NULL
