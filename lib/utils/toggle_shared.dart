...
class Button {
    ...
    static getDataButton() async {
        ...
        var visibleButton = prefs.getString('button');
        ...
        return json.decode(visibleButton);
    }
 
    static saveDataButton(visibleButton) async {
        var prefs = await SharedPreferences.getInstance();
        ...
        prefs.setString('button', json.encode(visibleButton));
    }
}